...
def makePulseCovariance(rfile,pulse_shape,time_bias=0,time_spread=250*1e-3,n_events=1e4):
    ...
    covmat_th2.GetXaxis().SetTitle("Sample-6")
    covmat_th2.GetYaxis().SetTitle("Sample-6")
    corrmat_th2.GetXaxis().SetTitle("Sample-6")
    corrmat_th2.GetYaxis().SetTitle("Sample-6")
    covmat_th2.Write()
    corrmat_th2.Write()
